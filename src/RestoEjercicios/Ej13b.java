...
public class Ej13b {
	...
	// Si un caracter es una letra, y es el ultimo caracter, se incrementa en uno el
	// contador de palabras.
	// Si un caracter es una letra, y NO es el ultimo caracter, palabra se convierte
	// true.
	// Si un caracter es un espacio, y palabra es true, palabra se convierte en
	// false y se incrementa en uno el contador de palabras.
